 ...
 *
 * @license MIT
 */function Ye(){return Ye=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Ye.apply(this,arguments)}var at;(function(t){t.Pop="POP",t.Push="PUSH",t.Replace="REPLACE"})(at||(at={}));const Yy="popstate";function vA(t){t===void 0&&(t={});function e(r,i){let{pathname:s,search:o,hash:l}=r.location;return al("",{pathname:s,search:o,hash:l},i.state&&i.state.usr||null,i.state&&i.state.key||"default")}function n(r,i){return typeof i=="string"?i:is(i)}return wA(e,n,null,t)}function ye(t,e){if(t===!1||t===null||typeof t>"u")throw new Error(e)}function ho(t,e){if(!t){typeof console<"u"&&console.warn(e);try{throw new Error(e)}catch{}}}function _A(){return Math.random().toString(36).substr(2,8)}function Xy(t,e){return{usr:t.state,key:t.key,idx:e}}function al(t,e,n,r){return n===void 0&&(n=null),Ye({pathname:typeof t=="string"?t:t.pathname,search:"",hash:""},typeof e=="string"?Pi(e):e,{state:n,key:e&&e.key||r||_A()})}function is(t){let{pathname:e="/",search:n="",hash:r=""}=t;return n&&n!=="?"&&(e+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(e+=r.charAt(0)==="#"?r:"#"+r),e}function Pi(t){let e={};if(t){let n=t.indexOf("#");n>=0&&(e.hash=t.substr(n),t=t.substr(0,n));let r=t.indexOf("?");r>=0&&(e.search=t.substr(r),t=t.substr(0,r)),t&&(e.pathname=t)}return e}function wA(t,e,n,r){r===void 0&&(r={});let{window:i=document.defaultView,v5Compat:s=!1}=r,o=i.history,l=at.Pop,u=null,c=d();c==null&&(c=0,o.replaceState(Ye({},o.state,{idx:c}),""));function d(){return(o.state||{idx:null}).idx}function f(){l=at.Pop;let O=d(),T=O==null?null:O-c;c=O,u&&u({action:l,location:C.location,delta:T})}function m(O,T){l=at.Push;let v=al(C.location,O,T);c=d()+1;let S=Xy(v,c),b=C.createHref(v);try{o.pushState(S,"",b)}catch(F){if(F instanceof DOMException&&F.name==="DataCloneError")throw F;i.location.assign(b)}s&&u&&u({action:l,location:C.location,delta:1})}function E(O,T){l=at.Replace;let v=al(C.location,O,T);c=d();let S=Xy(v,c),b=C.createHref(v);o.replaceState(S,"",b),s&&u&&u({action:l,location:C.location,delta:0})}function R(O){let T=i.location.origin!=="null"?i.location.origin:i.location.href,v=typeof O=="string"?O:is(O);return v=v.replace(/ $/,"%20"),ye(T,"No window.location.(origin|href) available to create URL for href: "+v),new URL(v,T)}let C={get action(){return l},get location(){return t(i,o)},listen(O){if(u)throw new Error("A history only accepts one active listener");return i.addEventListener(Yy,f),u=O,()=>{i.removeEventListener(Yy,f),u=null}},createHref(O){return e(i,O)},createURL:R,encodeLocation(O){let T=R(O);return{pathname:T.pathname,search:T.search,hash:T.hash}},push:m,replace:E,go(O){return o.go(O)}};return C}var be;(function(t){t.data="data",t.deferred="deferred",t.redirect="redirect",t.error="error"})(be||(be={}));const EA=new Set(["lazy","caseSensitive","path","id","index","children"]);function TA(t){return t.index===!0}function ll(t,e,n,r){return n===void 0&&(n=[]),r===void 0&&(r={}),t.map((i,s)=>{let o=[...n,String(s)],l=typeof i.id=="string"?i.id:o.join("-");if(ye(i.index!==!0||!i.children,"Cannot specify children on an index route"),ye(!r[l],'Found a route id collision on id "'+l+`".  Route id's must be globally unique within Data Router usages`),TA(i)){let u=Ye({},i,e(i),{id:l});return r[l]=u,u}else{let u=Ye({},i,e(i),{id:l,children:void 0});return r[l]=u,i.children&&(u.children=ll(i.children,e,o,r)),u}})}function ji(t,e,n){return n===void 0&&(n="/"),Fu(t,e,n,!1)}function Fu(t,e,n,r){let i=typeof e=="string"?Pi(e):e,s=No(i.pathname||"/",n);if(s==null)return null;let o=uE(t);SA(o);let l=null;for(let u=0;l==null&&u<o.length;++u){let c=LA(s);l=OA(o[u],c,r)}return l}function IA(t,e){let{route:n,pathname:r,params:i}=t;return{id:n.id,pathname:r,params:i,data:e[n.id],handle:n.handle}}function uE(t,e,n,r){e===void 0&&(e=[]),n===void 0&&(n=[]),r===void 0&&(r="");let i=(s,o,l)=>{let u={relativePath:l===void 0?s.path||"":l,caseSensitive:s.caseSensitive===!0,childrenIndex:o,route:s};u.relativePath.startsWith("/")&&(ye(u.relativePath.startsWith(r),'Absolute route path "'+u.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),u.relativePath=u.relativePath.slice(r.length));let c=Rr([r,u.relativePath]),d=n.concat(u);s.children&&s.children.length>0&&(ye(s.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+c+'".')),uE(s.children,e,d,c)),!(s.path==null&&!s.index)&&e.push({path:c,score:NA(c,s.index),routesMeta:d})};return t.forEach((s,o)=>{var l;if(s.path===""||!((l=s.path)!=null&&l.includes("?")))i(s,o);else for(let u of cE(s.path))i(s,o,u)}),e}function cE(t){let e=t.split("/");if(e.length===0)return[];let[n,...r]=e,i=n.endsWith("?"),s=n.replace(/\?$/,"");if(r.length===0)return i?[s,""]:[s];let o=cE(r.join("/")),l=[];return l.push(...o.map(u=>u===""?s:[s,u].join("/"))),i&&l.push(...o),l.map(u=>t.startsWith("/")&&u===""?"/":u)}function SA(t){t.sort((e,n)=>e.score!==n.score?n.score-e.score:DA(e.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const RA=/^:[\w-]+$/,AA=3,PA=2,CA=1,kA=10,xA=-2,Jy=t=>t==="*";function NA(t,e){let n=t.split("/"),r=n.length;return n.some(Jy)&&(r+=xA),e&&(r+=PA),n.filter(i=>!Jy(i)).reduce((i,s)=>i+(RA.test(s)?AA:s===""?CA:kA),r)}function DA(t,e){return t.length===e.length&&t.slice(0,-1).every((r,i)=>r===e[i])?t[t.length-1]-e[e.length-1]:0}function OA(t,e,n){n===void 0&&(n=!1);let{routesMeta:r}=t,i={},s="/",o=[];for(let l=0;l<r.length;++l){let u=r[l],c=l===r.length-1,d=s==="/"?e:e.slice(s.length)||"/",f=Zy({path:u.relativePath,caseSensitive:u.caseSensitive,end:c},d),m=u.route;if(!f&&c&&n&&!r[r.length-1].route.index&&(f=Zy({path:u.relativePath,caseSensitive:u.caseSensitive,end:!1},d)),!f)return null;Object.assign(i,f.params),o.push({params:i,pathname:Rr([s,f.pathname]),pathnameBase:FA(Rr([s,f.pathnameBase])),route:m}),f.pathnameBase!=="/"&&(s=Rr([s,f.pathnameBase]))}return o}function Zy(t,e){typeof t=="string"&&(t={path:t,caseSensitive:!1,end:!0});let[n,r]=bA(t.path,t.caseSensitive,t.end),i=e.match(n);if(!i)return null;let s=i[0],o=s.replace(/(.)\/+$/,"$1"),l=i.slice(1);return{params:r.reduce((c,d,f)=>{let{paramName:m,isOptional:E}=d;if(m==="*"){let C=l[f]||"";o=s.slice(0,s.length-C.length).replace(/(.)\/+$/,"$1")}const R=l[f];return E&&!R?c[m]=void 0:c[m]=(R||"").replace(/%2F/g,"/"),c},{}),pathname:s,pathnameBase:o,pattern:t}}function bA(t,e,n){e===void 0&&(e=!1),n===void 0&&(n=!0),ho(t==="*"||!t.endsWith("*")||t.endsWith("/*"),'Route path "'+t+'" will be treated as if it were '+('"'+t.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+t.replace(/\*$/,"/*")+'".'));let r=[],i="^"+t.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(o,l,u)=>(r.push({paramName:l,isOptional:u!=null}),u?"/?([^\\/]+)?":"/([^\\/]+)"));return t.endsWith("*")?(r.push({paramName:"*"}),i+=t==="*"||t==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":t!==""&&t!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,e?void 0:"i"),r]}function LA(t){try{return t.split("/").map(e=>decodeURIComponent(e).replace(/\//g,"%2F")).join("/")}catch(e){return ho(!1,'The URL path "'+t+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+e+").")),t}}function No(t,e){if(e==="/")return t;if(!t.toLowerCase().startsWith(e.toLowerCase()))return null;let n=e.endsWith("/")?e.length-1:e.length,r=t.charAt(n);return r&&r!=="/"?null:t.slice(n)||"/"}function MA(t,e){e===void 0&&(e="/");let{pathname:n,search:r="",hash:i=""}=typeof t=="string"?Pi(t):t;return{pathname:n?n.startsWith("/")?n:VA(n,e):e,search:UA(r),hash:jA(i)}}function VA(t,e){let n=e.replace(/\/+$/,"").split("/");return t.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function yd(t,e,n,r){return"Cannot include a '"+t+"' character in a manually specified "+("`to."+e+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function hE(t){return t.filter((e,n)=>n===0||e.route.path&&e.route.path.length>0)}function ah(t,e){let n=hE(t);return e?n.map((r,i)=>i===n.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function lh(t,e,n,r){r===void 0&&(r=!1);let i;typeof t=="string"?i=Pi(t):(i=Ye({},t),ye(!i.pathname||!i.pathname.includes("?"),yd("?","pathname","search",i)),ye(!i.pathname||!i.pathname.includes("#"),yd("#","pathname","hash",i)),ye(!i.search||!i.search.includes("#"),yd("#","search","hash",i)));let s=t===""||i.pathname==="",o=s?"/":i.pathname,l;if(o==null)l=n;else{let f=e.length-1;if(!r&&o.startsWith("..")){let m=o.split("/");for(;m[0]==="..";)m.shift(),f-=1;i.pathname=m.join("/")}l=f>=0?e[f]:"/"}let u=MA(i,l),c=o&&o!=="/"&&o.endsWith("/"),d=(s||o===".")&&n.endsWith("/");return!u.pathname.endsWith("/")&&(c||d)&&(u.pathname+="/"),u}const Rr=t=>t.join("/").replace(/\/\/+/g,"/"),FA=t=>t.replace(/\/+$/,"").replace(/^\/*/,"/"),UA=t=>!t||t==="?"?"":t.startsWith("?")?t:"?"+t,jA=t=>!t||t==="#"?"":t.startsWith("#")?t:"#"+t;class Ic{constructor(e,n,r,i){i===void 0&&(i=!1),this.status=e,this.statusText=n||"",this.internal=i,r instanceof Error?(this.data=r.toString(),this.error=r):this.data=r}}function uh(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.internal=="boolean"&&"data"in t}const dE=["post","put","patch","delete"],zA=new Set(dE),$A=["get",...dE],BA=new Set($A),HA=new Set([301,302,303,307,308]),WA=new Set([307,308]),vd={state:"idle",location:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},qA={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},da={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},dm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,KA=t=>({hasErrorBoundary:!!t.hasErrorBoundary}),fE="remix-router-transitions";function GA(t){const e=t.window?t.window:typeof window<"u"?window:void 0,n=typeof e<"u"&&typeof e.document<"u"&&typeof e.document.createElement<"u",r=!n;ye(t.routes.length>0,"You must provide a non-empty routes array to createRouter");let i;if(t.mapRouteProperties)i=t.mapRouteProperties;else if(t.detectErrorBoundary){let x=t.detectErrorBoundary;i=D=>({hasErrorBoundary:x(D)})}else i=KA;let s={},o=ll(t.routes,i,void 0,s),l,u=t.basename||"/",c=t.unstable_dataStrategy||ZA,d=t.unstable_patchRoutesOnMiss,f=Ye({v7_fetcherPersist:!1,v7_normalizeFormMethod:!1,v7_partialHydration:!1,v7_prependBasename:!1,v7_relativeSplatPath:!1,v7_skipActionErrorRevalidation:!1},t.future),m=null,E=new Set,R=null,C=null,O=null,T=t.hydrationData!=null,v=ji(o,t.history.location,u),S=null;if(v==null&&!d){let x=qt(404,{pathname:t.history.location.pathname}),{matches:D,route:M}=uv(o);v=D,S={[M.id]:x}}v&&!t.hydrationData&&Kn(v,o,t.history.location.pathname).active&&(v=null);let b;if(v)if(v.some(x=>x.route.lazy))b=!1;else if(!v.some(x=>x.route.loader))b=!0;else if(f.v7_partialHydration){let x=t.hydrationData?t.hydrationData.loaderData:null,D=t.hydrationData?t.hydrationData.errors:null,M=U=>U.route.loader?typeof U.route.loader=="function"&&U.route.loader.hydrate===!0?!1:x&&x[U.route.id]!==void 0||D&&D[U.route.id]!==void 0:!0;if(D){let U=v.findIndex(Q=>D[Q.route.id]!==void 0);b=v.slice(0,U+1).every(M)}else b=v.every(M)}else b=t.hydrationData!=null;else if(b=!1,v=[],f.v7_partialHydration){let x=Kn(null,o,t.history.location.pathname);x.active&&x.matches&&(v=x.matches)}let F,P={historyAction:t.history.action,location:t.history.location,matches:v,initialized:b,navigation:vd,restoreScrollPosition:t.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:t.hydrationData&&t.hydrationData.loaderData||{},actionData:t.hydrationData&&t.hydrationData.actionData||null,errors:t.hydrationData&&t.hydrationData.errors||S,fetchers:new Map,blockers:new Map},_=at.Pop,g=!1,w,I=!1,k=new Map,N=null,A=!1,K=!1,ae=[],We=new Set,de=new Map,G=0,Z=-1,ie=new Map,ge=new Set,fe=new Map,Ce=new Map,Ke=new Set,tt=new Map,Ge=new Map,Dt=new Map,Rn=!1;function An(){if(m=t.history.listen(x=>{let{action:D,location:M,delta:U}=x;if(Rn){Rn=!1;return}ho(Ge.size===0||U!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let Q=qo({currentLocation:P.location,nextLocation:M,historyAction:D});if(Q&&U!=null){Rn=!0,t.history.go(U*-1),Di(Q,{state:"blocked",location:M,proceed(){Di(Q,{state:"proceeding",proceed:void 0,reset:void 0,location:M}),t.history.go(U)},reset(){let ee=new Map(P.blockers);ee.set(Q,da),De({blockers:ee})}});return}return qn(D,M)}),n){dP(e,k);let x=()=>fP(e,k);e.addEventListener("pagehide",x),N=()=>e.removeEventListener("pagehide",x)}return P.initialized||qn(at.Pop,P.location,{initialHydration:!0}),F}function Hn(){m&&m(),N&&N(),E.clear(),w&&w.abort(),P.fetchers.forEach((x,D)=>_s(D)),P.blockers.forEach((x,D)=>Es(D))}function Pn(x){return E.add(x),()=>E.delete(x)}function De(x,D){D===void 0&&(D={}),P=Ye({},P,x);let M=[],U=[];f.v7_fetcherPersist&&P.fetchers.forEach((Q,ee)=>{Q.state==="idle"&&(Ke.has(ee)?U.push(ee):M.push(ee))}),[...E].forEach(Q=>Q(P,{deletedFetchers:U,unstable_viewTransitionOpts:D.viewTransitionOpts,unstable_flushSync:D.flushSync===!0})),f.v7_fetcherPersist&&(M.forEach(Q=>P.fetchers.delete(Q)),U.forEach(Q=>_s(Q)))}function Wn(x,D,M){var U,Q;let{flushSync:ee}=M===void 0?{}:M,se=P.actionData!=null&&P.navigation.formMethod!=null&&bn(P.navigation.formMethod)&&P.navigation.state==="loading"&&((U=x.state)==null?void 0:U._isRedirect)!==!0,W;D.actionData?Object.keys(D.actionData).length>0?W=D.actionData:W=null:se?W=P.actionData:W=null;let ue=D.loaderData?av(P.loaderData,D.loaderData,D.matches||[],D.errors):P.loaderData,te=P.blockers;te.size>0&&(te=new Map(te),te.forEach((Re,ke)=>te.set(ke,da)));let ne=g===!0||P.navigation.formMethod!=null&&bn(P.navigation.formMethod)&&((Q=x.state)==null?void 0:Q._isRedirect)!==!0;l&&(o=l,l=void 0),A||_===at.Pop||(_===at.Push?t.history.push(x,x.state):_===at.Replace&&t.history.replace(x,x.state));let ve;if(_===at.Pop){let Re=k.get(P.location.pathname);Re&&Re.has(x.pathname)?ve={currentLocation:P.location,nextLocation:x}:k.has(x.pathname)&&(ve={currentLocation:x,nextLocation:P.location})}else if(I){let Re=k.get(P.location.pathname);Re?Re.add(x.pathname):(Re=new Set([x.pathname]),k.set(P.location.pathname,Re)),ve={currentLocation:P.location,nextLocation:x}}De(Ye({},D,{actionData:W,loaderData:ue,historyAction:_,location:x,initialized:!0,navigation:vd,revalidation:"idle",restoreScrollPosition:Go(x,D.matches||P.matches),preventScrollReset:ne,blockers:te}),{viewTransitionOpts:ve,flushSync:ee===!0}),_=at.Pop,g=!1,I=!1,A=!1,K=!1,ae=[]}async function vs(x,D){if(typeof x=="number"){t.history.go(x);return}let M=Lf(P.location,P.matches,u,f.v7_prependBasename,x,f.v7_relativeSplatPath,D==null?void 0:D.fromRouteId,D==null?void 0:D.relative),{path:U,submission:Q,error:ee}=ev(f.v7_normalizeFormMethod,!1,M,D),se=P.location,W=al(P.location,U,D&&D.state);W=Ye({},W,t.history.encodeLocation(W));let ue=D&&D.replace!=null?D.replace:void 0,te=at.Push;ue===!0?te=at.Replace:ue===!1||Q!=null&&bn(Q.formMethod)&&Q.formAction===P.location.pathname+P.location.search&&(te=at.Replace);let ne=D&&"preventScrollReset"in D?D.preventScrollReset===!0:void 0,ve=(D&&D.unstable_flushSync)===!0,Re=qo({currentLocation:se,nextLocation:W,historyAction:te});if(Re){Di(Re,{state:"blocked",location:W,proceed(){Di(Re,{state:"proceeding",proceed:void 0,reset:void 0,location:W}),vs(x,D)},reset(){let ke=new Map(P.blockers);ke.set(Re,da),De({blockers:ke})}});return}return await qn(te,W,{submission:Q,pendingError:ee,preventScrollReset:ne,replace:D&&D.replace,enableViewTransition:D&&D.unstable_viewTransition,flushSync:ve})}function jo(){if(ft(),De({revalidation:"loading"}),P.navigation.state!=="submitting"){if(P.navigation.state==="idle"){qn(P.historyAction,P.location,{startUninterruptedRevalidation:!0});return}qn(_||P.historyAction,P.navigation.location,{overrideNavigation:P.navigation})}}async function qn(x,D,M){w&&w.abort(),w=null,_=x,A=(M&&M.startUninterruptedRevalidation)===!0,Ts(P.location,P.matches),g=(M&&M.preventScrollReset)===!0,I=(M&&M.enableViewTransition)===!0;let U=l||o,Q=M&&M.overrideNavigation,ee=ji(U,D,u),se=(M&&M.flushSync)===!0,W=Kn(ee,U,D.pathname);if(W.active&&W.matches&&(ee=W.matches),!ee){let{error:Te,notFoundMatches:it,route:Qe}=hr(D.pathname);Wn(D,{matches:it,loaderData:{},errors:{[Qe.id]:Te}},{flushSync:se});return}if(P.initialized&&!K&&sP(P.location,D)&&!(M&&M.submission&&bn(M.submission.formMethod))){Wn(D,{matches:ee},{flushSync:se});return}w=new AbortController;let ue=Cs(t.history,D,w.signal,M&&M.submission),te;if(M&&M.pendingError)te=[Ws(ee).route.id,{type:be.error,error:M.pendingError}];else if(M&&M.submission&&bn(M.submission.formMethod)){let Te=await Mh(ue,D,M.submission,ee,W.active,{replace:M.replace,flushSync:se});if(Te.shortCircuited)return;if(Te.pendingActionResult){let[it,Qe]=Te.pendingActionResult;if(un(Qe)&&uh(Qe.error)&&Qe.error.status===404){w=null,Wn(D,{matches:Te.matches,loaderData:{},errors:{[it]:Qe.error}});return}}ee=Te.matches||ee,te=Te.pendingActionResult,Q=_d(D,M.submission),se=!1,W.active=!1,ue=Cs(t.history,ue.url,ue.signal)}let{shortCircuited:ne,matches:ve,loaderData:Re,errors:ke}=await Vh(ue,D,ee,W.active,Q,M&&M.submission,M&&M.fetcherSubmission,M&&M.replace,M&&M.initialHydration===!0,se,te);ne||(w=null,Wn(D,Ye({matches:ve||ee},lv(te),{loaderData:Re,errors:ke})))}async function Mh(x,D,M,U,Q,ee){ee===void 0&&(ee={}),ft();let se=cP(D,M);if(De({navigation:se},{flushSync:ee.flushSync===!0}),Q){let te=await bi(U,D.pathname,x.signal);if(te.type==="aborted")return{shortCircuited:!0};if(te.type==="error"){let{boundaryId:ne,error:ve}=Fr(D.pathname,te);return{matches:te.partialMatches,pendingActionResult:[ne,{type:be.error,error:ve}]}}else if(te.matches)U=te.matches;else{let{notFoundMatches:ne,error:ve,route:Re}=hr(D.pathname);return{matches:ne,pendingActionResult:[Re.id,{type:be.error,error:ve}]}}}let W,ue=wa(U,D);if(!ue.route.action&&!ue.route.lazy)W={type:be.error,error:qt(405,{method:x.method,pathname:D.pathname,routeId:ue.route.id})};else if(W=(await Vr("action",x,[ue],U))[0],x.signal.aborted)return{shortCircuited:!0};if(Wi(W)){let te;return ee&&ee.replace!=null?te=ee.replace:te=iv(W.response.headers.get("Location"),new URL(x.url),u)===P.location.pathname+P.location.search,await cr(x,W,{submission:M,replace:te}),{shortCircuited:!0}}if(Hi(W))throw qt(400,{type:"defer-action"});if(un(W)){let te=Ws(U,ue.route.id);return(ee&&ee.replace)!==!0&&(_=at.Push),{matches:U,pendingActionResult:[te.route.id,W]}}return{matches:U,pendingActionResult:[ue.route.id,W]}}async function Vh(x,D,M,U,Q,ee,se,W,ue,te,ne){let ve=Q||_d(D,ee),Re=ee||se||fv(ve),ke=!A&&(!f.v7_partialHydration||!ue);if(U){if(ke){let Ue=zo(ne);De(Ye({navigation:ve},Ue!==void 0?{actionData:Ue}:{}),{flushSync:te})}let pe=await bi(M,D.pathname,x.signal);if(pe.type==="aborted")return{shortCircuited:!0};if(pe.type==="error"){let{boundaryId:Ue,error:bt}=Fr(D.pathname,pe);return{matches:pe.partialMatches,loaderData:{},errors:{[Ue]:bt}}}else if(pe.matches)M=pe.matches;else{let{error:Ue,notFoundMatches:bt,route:Oe}=hr(D.pathname);return{matches:bt,loaderData:{},errors:{[Oe.id]:Ue}}}}let Te=l||o,[it,Qe]=tv(t.history,P,M,Re,D,f.v7_partialHydration&&ue===!0,f.v7_skipActionErrorRevalidation,K,ae,We,Ke,fe,ge,Te,u,ne);if(Oi(pe=>!(M&&M.some(Ue=>Ue.route.id===pe))||it&&it.some(Ue=>Ue.route.id===pe)),Z=++G,it.length===0&&Qe.length===0){let pe=ws();return Wn(D,Ye({matches:M,loaderData:{},errors:ne&&un(ne[1])?{[ne[0]]:ne[1].error}:null},lv(ne),pe?{fetchers:new Map(P.fetchers)}:{}),{flushSync:te}),{shortCircuited:!0}}if(ke){let pe={};if(!U){pe.navigation=ve;let Ue=zo(ne);Ue!==void 0&&(pe.actionData=Ue)}Qe.length>0&&(pe.fetchers=$o(Qe)),De(pe,{flushSync:te})}Qe.forEach(pe=>{de.has(pe.key)&&Cn(pe.key),pe.controller&&de.set(pe.key,pe.controller)});let Ur=()=>Qe.forEach(pe=>Cn(pe.key));w&&w.signal.addEventListener("abort",Ur);let{loaderResults:Gn,fetcherResults:kn}=await dt(P.matches,M,it,Qe,x);if(x.signal.aborted)return{shortCircuited:!0};w&&w.signal.removeEventListener("abort",Ur),Qe.forEach(pe=>de.delete(pe.key));let fr=cv([...Gn,...kn]);if(fr){if(fr.idx>=it.length){let pe=Qe[fr.idx-it.length].key;ge.add(pe)}return await cr(x,fr.result,{replace:W}),{shortCircuited:!0}}let{loaderData:Qn,errors:Ot}=ov(P,M,it,Gn,ne,Qe,kn,tt);tt.forEach((pe,Ue)=>{pe.subscribe(bt=>{(bt||pe.done)&&tt.delete(Ue)})}),f.v7_partialHydration&&ue&&P.errors&&Object.entries(P.errors).filter(pe=>{let[Ue]=pe;return!it.some(bt=>bt.route.id===Ue)}).forEach(pe=>{let[Ue,bt]=pe;Ot=Object.assign(Ot||{},{[Ue]:bt})});let yn=ws(),jr=Bl(Z),Is=yn||jr||Qe.length>0;return Ye({matches:M,loaderData:Qn,errors:Ot},Is?{fetchers:new Map(P.fetchers)}:{})}function zo(x){if(x&&!un(x[1]))return{[x[0]]:x[1].data};if(P.actionData)return Object.keys(P.actionData).length===0?null:P.actionData}function $o(x){return x.forEach(D=>{let M=P.fetchers.get(D.key),U=fa(void 0,M?M.data:void 0);P.fetchers.set(D.key,U)}),new Map(P.fetchers)}function $l(x,D,M,U){if(r)throw new Error("router.fetch() was called during the server render, but it shouldn't be. You are likely calling a useFetcher() method in the body of your component. Try moving it to a useEffect or a callback.");de.has(x)&&Cn(x);let Q=(U&&U.unstable_flushSync)===!0,ee=l||o,se=Lf(P.location,P.matches,u,f.v7_prependBasename,M,f.v7_relativeSplatPath,D,U==null?void 0:U.relative),W=ji(ee,se,u),ue=Kn(W,ee,se);if(ue.active&&ue.matches&&(W=ue.matches),!W){gn(x,D,qt(404,{pathname:se}),{flushSync:Q});return}let{path:te,submission:ne,error:ve}=ev(f.v7_normalizeFormMethod,!0,se,U);if(ve){gn(x,D,ve,{flushSync:Q});return}let Re=wa(W,te);if(g=(U&&U.preventScrollReset)===!0,ne&&bn(ne.formMethod)){Fh(x,D,te,Re,W,ue.active,Q,ne);return}fe.set(x,{routeId:D,path:te}),Bo(x,D,te,Re,W,ue.active,Q,ne)}async function Fh(x,D,M,U,Q,ee,se,W){ft(),fe.delete(x);function ue(Oe){if(!Oe.route.action&&!Oe.route.lazy){let sn=qt(405,{method:W.formMethod,pathname:M,routeId:D});return gn(x,D,sn,{flushSync:se}),!0}return!1}if(!ee&&ue(U))return;let te=P.fetchers.get(x);rn(x,hP(W,te),{flushSync:se});let ne=new AbortController,ve=Cs(t.history,M,ne.signal,W);if(ee){let Oe=await bi(Q,M,ve.signal);if(Oe.type==="aborted")return;if(Oe.type==="error"){let{error:sn}=Fr(M,Oe);gn(x,D,sn,{flushSync:se});return}else if(Oe.matches){if(Q=Oe.matches,U=wa(Q,M),ue(U))return}else{gn(x,D,qt(404,{pathname:M}),{flushSync:se});return}}de.set(x,ne);let Re=G,Te=(await Vr("action",ve,[U],Q))[0];if(ve.signal.aborted){de.get(x)===ne&&de.delete(x);return}if(f.v7_fetcherPersist&&Ke.has(x)){if(Wi(Te)||un(Te)){rn(x,Wr(void 0));return}}else{if(Wi(Te))if(de.delete(x),Z>Re){rn(x,Wr(void 0));return}else return ge.add(x),rn(x,fa(W)),cr(ve,Te,{fetcherSubmission:W});if(un(Te)){gn(x,D,Te.error);return}}if(Hi(Te))throw qt(400,{type:"defer-action"});let it=P.navigation.location||P.location,Qe=Cs(t.history,it,ne.signal),Ur=l||o,Gn=P.navigation.state!=="idle"?ji(Ur,P.navigation.location,u):P.matches;ye(Gn,"Didn't find any matches after fetcher action");let kn=++G;ie.set(x,kn);let fr=fa(W,Te.data);P.fetchers.set(x,fr);let[Qn,Ot]=tv(t.history,P,Gn,W,it,!1,f.v7_skipActionErrorRevalidation,K,ae,We,Ke,fe,ge,Ur,u,[U.route.id,Te]);Ot.filter(Oe=>Oe.key!==x).forEach(Oe=>{let sn=Oe.key,Qo=P.fetchers.get(sn),Wl=fa(void 0,Qo?Qo.data:void 0);P.fetchers.set(sn,Wl),de.has(sn)&&Cn(sn),Oe.controller&&de.set(sn,Oe.controller)}),De({fetchers:new Map(P.fetchers)});let yn=()=>Ot.forEach(Oe=>Cn(Oe.key));ne.signal.addEventListener("abort",yn);let{loaderResults:jr,fetcherResults:Is}=await dt(P.matches,Gn,Qn,Ot,Qe);if(ne.signal.aborted)return;ne.signal.removeEventListener("abort",yn),ie.delete(x),de.delete(x),Ot.forEach(Oe=>de.delete(Oe.key));let pe=cv([...jr,...Is]);if(pe){if(pe.idx>=Qn.length){let Oe=Ot[pe.idx-Qn.length].key;ge.add(Oe)}return cr(Qe,pe.result)}let{loaderData:Ue,errors:bt}=ov(P,P.matches,Qn,jr,void 0,Ot,Is,tt);if(P.fetchers.has(x)){let Oe=Wr(Te.data);P.fetchers.set(x,Oe)}Bl(kn),P.navigation.state==="loading"&&kn>Z?(ye(_,"Expected pending action"),w&&w.abort(),Wn(P.navigation.location,{matches:Gn,loaderData:Ue,errors:bt,fetchers:new Map(P.fetchers)})):(De({errors:bt,loaderData:av(P.loaderData,Ue,Gn,bt),fetchers:new Map(P.fetchers)}),K=!1)}async function Bo(x,D,M,U,Q,ee,se,W){let ue=P.fetchers.get(x);rn(x,fa(W,ue?ue.data:void 0),{flushSync:se});let te=new AbortController,ne=Cs(t.history,M,te.signal);if(ee){let Te=await bi(Q,M,ne.signal);if(Te.type==="aborted")return;if(Te.type==="error"){let{error:it}=Fr(M,Te);gn(x,D,it,{flushSync:se});return}else if(Te.matches)Q=Te.matches,U=wa(Q,M);else{gn(x,D,qt(404,{pathname:M}),{flushSync:se});return}}de.set(x,te);let ve=G,ke=(await Vr("loader",ne,[U],Q))[0];if(Hi(ke)&&(ke=await vE(ke,ne.signal,!0)||ke),de.get(x)===te&&de.delete(x),!ne.signal.aborted){if(Ke.has(x)){rn(x,Wr(void 0));return}if(Wi(ke))if(Z>ve){rn(x,Wr(void 0));return}else{ge.add(x),await cr(ne,ke);return}if(un(ke)){gn(x,D,ke.error);return}ye(!Hi(ke),"Unhandled fetcher deferred data"),rn(x,Wr(ke.data))}}async function cr(x,D,M){let{submission:U,fetcherSubmission:Q,replace:ee}=M===void 0?{}:M;D.response.headers.has("X-Remix-Revalidate")&&(K=!0);let se=D.response.headers.get("Location");ye(se,"Expected a Location header on the redirect Response"),se=iv(se,new URL(x.url),u);let W=al(P.location,se,{_isRedirect:!0});if(n){let ke=!1;if(D.response.headers.has("X-Remix-Reload-Document"))ke=!0;else if(dm.test(se)){const Te=t.history.createURL(se);ke=Te.origin!==e.location.origin||No(Te.pathname,u)==null}if(ke){ee?e.location.replace(se):e.location.assign(se);return}}w=null;let ue=ee===!0||D.response.headers.has("X-Remix-Replace")?at.Replace:at.Push,{formMethod:te,formAction:ne,formEncType:ve}=P.navigation;!U&&!Q&&te&&ne&&ve&&(U=fv(P.navigation));let Re=U||Q;if(WA.has(D.response.status)&&Re&&bn(Re.formMethod))await qn(ue,W,{submission:Ye({},Re,{formAction:se}),preventScrollReset:g});else{let ke=_d(W,U);await qn(ue,W,{overrideNavigation:ke,fetcherSubmission:Q,preventScrollReset:g})}}async function Vr(x,D,M,U){try{let Q=await eP(c,x,D,M,U,s,i);return await Promise.all(Q.map((ee,se)=>{if(aP(ee)){let W=ee.result;return{type:be.redirect,response:rP(W,D,M[se].route.id,U,u,f.v7_relativeSplatPath)}}return nP(ee)}))}catch(Q){return M.map(()=>({type:be.error,error:Q}))}}async function dt(x,D,M,U,Q){let[ee,...se]=await Promise.all([M.length?Vr("loader",Q,M,D):[],...U.map(W=>{if(W.matches&&W.match&&W.controller){let ue=Cs(t.history,W.path,W.controller.signal);return Vr("loader",ue,[W.match],W.matches).then(te=>te[0])}else return Promise.resolve({type:be.error,error:qt(404,{pathname:W.path})})})]);return await Promise.all([dv(x,M,ee,ee.map(()=>Q.signal),!1,P.loaderData),dv(x,U.map(W=>W.match),se,U.map(W=>W.controller?W.controller.signal:null),!0)]),{loaderResults:ee,fetcherResults:se}}function ft(){K=!0,ae.push(...Oi()),fe.forEach((x,D)=>{de.has(D)&&(We.add(D),Cn(D))})}function rn(x,D,M){M===void 0&&(M={}),P.fetchers.set(x,D),De({fetchers:new Map(P.fetchers)},{flushSync:(M&&M.flushSync)===!0})}function gn(x,D,M,U){U===void 0&&(U={});let Q=Ws(P.matches,D);_s(x),De({errors:{[Q.route.id]:M},fetchers:new Map(P.fetchers)},{flushSync:(U&&U.flushSync)===!0})}function Ho(x){return f.v7_fetcherPersist&&(Ce.set(x,(Ce.get(x)||0)+1),Ke.has(x)&&Ke.delete(x)),P.fetchers.get(x)||qA}function _s(x){let D=P.fetchers.get(x);de.has(x)&&!(D&&D.state==="loading"&&ie.has(x))&&Cn(x),fe.delete(x),ie.delete(x),ge.delete(x),Ke.delete(x),We.delete(x),P.fetchers.delete(x)}function Ni(x){if(f.v7_fetcherPersist){let D=(Ce.get(x)||0)-1;D<=0?(Ce.delete(x),Ke.add(x)):Ce.set(x,D)}else _s(x);De({fetchers:new Map(P.fetchers)})}function Cn(x){let D=de.get(x);ye(D,"Expected fetch controller: "+x),D.abort(),de.delete(x)}function Wo(x){for(let D of x){let M=Ho(D),U=Wr(M.data);P.fetchers.set(D,U)}}function ws(){let x=[],D=!1;for(let M of ge){let U=P.fetchers.get(M);ye(U,"Expected fetcher: "+M),U.state==="loading"&&(ge.delete(M),x.push(M),D=!0)}return Wo(x),D}function Bl(x){let D=[];for(let[M,U]of ie)if(U<x){let Q=P.fetchers.get(M);ye(Q,"Expected fetcher: "+M),Q.state==="loading"&&(Cn(M),ie.delete(M),D.push(M))}return Wo(D),D.length>0}function Uh(x,D){let M=P.blockers.get(x)||da;return Ge.get(x)!==D&&Ge.set(x,D),M}function Es(x){P.blockers.delete(x),Ge.delete(x)}function Di(x,D){let M=P.blockers.get(x)||da;ye(M.state==="unblocked"&&D.state==="blocked"||M.state==="blocked"&&D.state==="blocked"||M.state==="blocked"&&D.state==="proceeding"||M.state==="blocked"&&D.state==="unblocked"||M.state==="proceeding"&&D.state==="unblocked","Invalid blocker state transition: "+M.state+" -> "+D.state);let U=new Map(P.blockers);U.set(x,D),De({blockers:U})}function qo(x){let{currentLocation:D,nextLocation:M,historyAction:U}=x;if(Ge.size===0)return;Ge.size>1&&ho(!1,"A router only supports one blocker at a time");let Q=Array.from(Ge.entries()),[ee,se]=Q[Q.length-1],W=P.blockers.get(ee);if(!(W&&W.state==="proceeding")&&se({currentLocation:D,nextLocation:M,historyAction:U}))return ee}function hr(x){let D=qt(404,{pathname:x}),M=l||o,{matches:U,route:Q}=uv(M);return Oi(),{notFoundMatches:U,route:Q,error:D}}function Fr(x,D){return{boundaryId:Ws(D.partialMatches).route.id,error:qt(400,{type:"route-discovery",pathname:x,message:D.error!=null&&"message"in D.error?D.error:String(D.error)})}}function Oi(x){let D=[];return tt.forEach((M,U)=>{(!x||x(U))&&(M.cancel(),D.push(U),tt.delete(U))}),D}function dr(x,D,M){if(R=x,O=D,C=M||null,!T&&P.navigation===vd){T=!0;let U=Go(P.location,P.matches);U!=null&&De({restoreScrollPosition:U})}return()=>{R=null,O=null,C=null}}function Ko(x,D){return C&&C(x,D.map(U=>IA(U,P.loaderData)))||x.key}function Ts(x,D){if(R&&O){let M=Ko(x,D);R[M]=O()}}function Go(x,D){if(R){let M=Ko(x,D),U=R[M];if(typeof U=="number")return U}return null}function Kn(x,D,M){if(d)if(x){let U=x[x.length-1].route;if(U.path&&(U.path==="*"||U.path.endsWith("/*")))return{active:!0,matches:Fu(D,M,u,!0)}}else return{active:!0,matches:Fu(D,M,u,!0)||[]};return{active:!1,matches:null}}async function bi(x,D,M){let U=x,Q=U.length>0?U[U.length-1].route:null;for(;;){let ee=l==null,se=l||o;try{await JA(d,D,U,se,s,i,Dt,M)}catch(ne){return{type:"error",error:ne,partialMatches:U}}finally{ee&&(o=[...o])}if(M.aborted)return{type:"aborted"};let W=ji(se,D,u),ue=!1;if(W){let ne=W[W.length-1].route;if(ne.index)return{type:"success",matches:W};if(ne.path&&ne.path.length>0)if(ne.path==="*")ue=!0;else return{type:"success",matches:W}}let te=Fu(se,D,u,!0);if(!te||U.map(ne=>ne.route.id).join("-")===te.map(ne=>ne.route.id).join("-"))return{type:"success",matches:ue?W:null};if(U=te,Q=U[U.length-1].route,Q.path==="*")return{type:"success",matches:U}}}function Tt(x){s={},l=ll(x,i,void 0,s)}function Hl(x,D){let M=l==null;mE(x,D,l||o,s,i),M&&(o=[...o],De({}))}return F={get basename(){return u},get future(){return f},get state(){return P},get routes(){return o},get window(){return e},initialize:An,subscribe:Pn,enableScrollRestoration:dr,navigate:vs,fetch:$l,revalidate:jo,createHref:x=>t.history.createHref(x),encodeLocation:x=>t.history.encodeLocation(x),getFetcher:Ho,deleteFetcher:Ni,dispose:Hn,getBlocker:Uh,deleteBlocker:Es,patchRoutes:Hl,_internalFetchControllers:de,_internalActiveDeferreds:tt,_internalSetRoutes:Tt},F}function QA(t){return t!=null&&("formData"in t&&t.formData!=null||"body"in t&&t.body!==void 0)}function Lf(t,e,n,r,i,s,o,l){let u,c;if(o){u=[];for(let f of e)if(u.push(f),f.route.id===o){c=f;break}}else u=e,c=e[e.length-1];let d=lh(i||".",ah(u,s),No(t.pathname,n)||t.pathname,l==="path");return i==null&&(d.search=t.search,d.hash=t.hash),(i==null||i===""||i===".")&&c&&c.route.index&&!fm(d.search)&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),r&&n!=="/"&&(d.pathname=d.pathname==="/"?n:Rr([n,d.pathname])),is(d)}function ev(t,e,n,r){if(!r||!QA(r))return{path:n};if(r.formMethod&&!uP(r.formMethod))return{path:n,error:qt(405,{method:r.formMethod})};let i=()=>({path:n,error:qt(400,{type:"invalid-body"})}),s=r.formMethod||"get",o=t?s.toUpperCase():s.toLowerCase(),l=gE(n);if(r.body!==void 0){if(r.formEncType==="text/plain"){if(!bn(o))return i();let m=typeof r.body=="string"?r.body:r.body instanceof FormData||r.body instanceof URLSearchParams?Array.from(r.body.entries()).reduce((E,R)=>{let[C,O]=R;return""+E+C+"="+O+`
`},""):String(r.body);return{path:n,submission:{formMethod:o,formAction:l,formEncType:r.formEncType,formData:void 0,json:void 0,text:m}}}else if(r.formEncType==="application/json"){if(!bn(o))return i();try{let m=typeof r.body=="string"?JSON.parse(r.body):r.body;return{path:n,submission:{formMethod:o,formAction:l,formEncType:r.formEncType,formData:void 0,json:m,text:void 0}}}catch{return i()}}}ye(typeof FormData=="function","FormData is not available in this environment");let u,c;if(r.formData)u=Mf(r.formData),c=r.formData;else if(r.body instanceof FormData)u=Mf(r.body),c=r.body;else if(r.body instanceof URLSearchParams)u=r.body,c=sv(u);else if(r.body==null)u=new URLSearchParams,c=new FormData;else try{u=new URLSearchParams(r.body),c=sv(u)}catch{return i()}let d={formMethod:o,formAction:l,formEncType:r&&r.formEncType||"application/x-www-form-urlencoded",formData:c,json:void 0,text:void 0};if(bn(d.formMethod))return{path:n,submission:d};let f=Pi(n);return e&&f.search&&fm(f.search)&&u.append("index",""),f.search="?"+u,{path:is(f),submission:d}}function YA(t,e){let n=t;if(e){let r=t.findIndex(i=>i.route.id===e);r>=0&&(n=t.slice(0,r))}return n}function tv(t,e,n,r,i,s,o,l,u,c,d,f,m,E,R,C){let O=C?un(C[1])?C[1].error:C[1].data:void 0,T=t.createURL(e.location),v=t.createURL(i),S=C&&un(C[1])?C[0]:void 0,b=S?YA(n,S):n,F=C?C[1].statusCode:void 0,P=o&&F&&F>=400,_=b.filter((w,I)=>{let{route:k}=w;if(k.lazy)return!0;if(k.loader==null)return!1;if(s)return typeof k.loader!="function"||k.loader.hydrate?!0:e.loaderData[k.id]===void 0&&(!e.errors||e.errors[k.id]===void 0);if(XA(e.loaderData,e.matches[I],w)||u.some(K=>K===w.route.id))return!0;let N=e.matches[I],A=w;return nv(w,Ye({currentUrl:T,currentParams:N.params,nextUrl:v,nextParams:A.params},r,{actionResult:O,actionStatus:F,defaultShouldRevalidate:P?!1:l||T.pathname+T.search===v.pathname+v.search||T.search!==v.search||pE(N,A)}))}),g=[];return f.forEach((w,I)=>{if(s||!n.some(ae=>ae.route.id===w.routeId)||d.has(I))return;let k=ji(E,w.path,R);if(!k){g.push({key:I,routeId:w.routeId,path:w.path,matches:null,match:null,controller:null});return}let N=e.fetchers.get(I),A=wa(k,w.path),K=!1;m.has(I)?K=!1:c.has(I)?(c.delete(I),K=!0):N&&N.state!=="idle"&&N.data===void 0?K=l:K=nv(A,Ye({currentUrl:T,currentParams:e.matches[e.matches.length-1].params,nextUrl:v,nextParams:n[n.length-1].params},r,{actionResult:O,actionStatus:F,defaultShouldRevalidate:P?!1:l})),K&&g.push({key:I,routeId:w.routeId,path:w.path,matches:k,match:A,controller:new AbortController})}),[_,g]}function XA(t,e,n){let r=!e||n.route.id!==e.route.id,i=t[n.route.id]===void 0;return r||i}function pE(t,e){let n=t.route.path;return t.pathname!==e.pathname||n!=null&&n.endsWith("*")&&t.params["*"]!==e.params["*"]}function nv(t,e){if(t.route.shouldRevalidate){let n=t.route.shouldRevalidate(e);if(typeof n=="boolean")return n}return e.defaultShouldRevalidate}async function JA(t,e,n,r,i,s,o,l){let u=[e,...n.map(c=>c.route.id)].join("-");try{let c=o.get(u);c||(c=t({path:e,matches:n,patch:(d,f)=>{l.aborted||mE(d,f,r,i,s)}}),o.set(u,c)),c&&oP(c)&&await c}finally{o.delete(u)}}function mE(t,e,n,r,i){if(t){var s;let o=r[t];ye(o,"No route found to patch children into: routeId = "+t);let l=ll(e,i,[t,"patch",String(((s=o.children)==null?void 0:s.length)||"0")],r);o.children?o.children.push(...l):o.children=l}else{let o=ll(e,i,["patch",String(n.length||"0")],r);n.push(...o)}}async function rv(t,e,n){if(!t.lazy)return;let r=await t.lazy();if(!t.lazy)return;let i=n[t.id];ye(i,"No route found in manifest");let s={};for(let o in r){let u=i[o]!==void 0&&o!=="hasErrorBoundary";ho(!u,'Route "'+i.id+'" has a static property "'+o+'" defined but its lazy function is also returning a value for this property. '+('The lazy route property "'+o+'" will be ignored.')),!u&&!EA.has(o)&&(s[o]=r[o])}Object.assign(i,s),Object.assign(i,Ye({},e(i),{lazy:void 0}))}function ZA(t){return Promise.all(t.matches.map(e=>e.resolve()))}async function eP(t,e,n,r,i,s,o,l){let u=r.reduce((f,m)=>f.add(m.route.id),new Set),c=new Set,d=await t({matches:i.map(f=>{let m=u.has(f.route.id);return Ye({},f,{shouldLoad:m,resolve:R=>(c.add(f.route.id),m?tP(e,n,f,s,o,R,l):Promise.resolve({type:be.data,result:void 0}))})}),request:n,params:i[0].params,context:l});return i.forEach(f=>ye(c.has(f.route.id),'`match.resolve()` was not called for route id "'+f.route.id+'". You must call `match.resolve()` on every match passed to `dataStrategy` to ensure all routes are properly loaded.')),d.filter((f,m)=>u.has(i[m].route.id))}async function tP(t,e,n,r,i,s,o){let l,u,c=d=>{let f,m=new Promise((C,O)=>f=O);u=()=>f(),e.signal.addEventListener("abort",u);let E=C=>typeof d!="function"?Promise.reject(new Error("You cannot call the handler for a route which defines a boolean "+('"'+t+'" [routeId: '+n.route.id+"]"))):d({request:e,params:n.params,context:o},...C!==void 0?[C]:[]),R;return s?R=s(C=>E(C)):R=(async()=>{try{return{type:"data",result:await E()}}catch(C){return{type:"error",result:C}}})(),Promise.race([R,m])};try{let d=n.route[t];if(n.route.lazy)if(d){let f,[m]=await Promise.all([c(d).catch(E=>{f=E}),rv(n.route,i,r)]);if(f!==void 0)throw f;l=m}else if(await rv(n.route,i,r),d=n.route[t],d)l=await c(d);else if(t==="action"){let f=new URL(e.url),m=f.pathname+f.search;throw qt(405,{method:e.method,pathname:m,routeId:n.route.id})}else return{type:be.data,result:void 0};else if(d)l=await c(d);else{let f=new URL(e.url),m=f.pathname+f.search;throw qt(404,{pathname:m})}ye(l.result!==void 0,"You defined "+(t==="action"?"an action":"a loader")+" for route "+('"'+n.route.id+"\" but didn't return anything from your `"+t+"` ")+"function. Please return a value or `null`.")}catch(d){return{type:be.error,result:d}}finally{u&&e.signal.removeEventListener("abort",u)}return l}async function nP(t){let{result:e,type:n}=t;if(yE(e)){let c;try{let d=e.headers.get("Content-Type");d&&/\bapplication\/json\b/.test(d)?e.body==null?c=null:c=await e.json():c=await e.text()}catch(d){return{type:be.error,error:d}}return n===be.error?{type:be.error,error:new Ic(e.status,e.statusText,c),statusCode:e.status,headers:e.headers}:{type:be.data,data:c,statusCode:e.status,headers:e.headers}}if(n===be.error){if(hv(e)){var r;if(e.data instanceof Error){var i;return{type:be.error,error:e.data,statusCode:(i=e.init)==null?void 0:i.status}}e=new Ic(((r=e.init)==null?void 0:r.status)||500,void 0,e.data)}return{type:be.error,error:e,statusCode:uh(e)?e.status:void 0}}if(lP(e)){var s,o;return{type:be.deferred,deferredData:e,statusCode:(s=e.init)==null?void 0:s.status,headers:((o=e.init)==null?void 0:o.headers)&&new Headers(e.init.headers)}}if(hv(e)){var l,u;return{type:be.data,data:e.data,statusCode:(l=e.init)==null?void 0:l.status,headers:(u=e.init)!=null&&u.headers?new Headers(e.init.headers):void 0}}return{type:be.data,data:e}}function rP(t,e,n,r,i,s){let o=t.headers.get("Location");if(ye(o,"Redirects returned/thrown from loaders/actions must have a Location header"),!dm.test(o)){let l=r.slice(0,r.findIndex(u=>u.route.id===n)+1);o=Lf(new URL(e.url),l,i,!0,o,s),t.headers.set("Location",o)}return t}function iv(t,e,n){if(dm.test(t)){let r=t,i=r.startsWith("//")?new URL(e.protocol+r):new URL(r),s=No(i.pathname,n)!=null;if(i.origin===e.origin&&s)return i.pathname+i.search+i.hash}return t}function Cs(t,e,n,r){let i=t.createURL(gE(e)).toString(),s={signal:n};if(r&&bn(r.formMethod)){let{formMethod:o,formEncType:l}=r;s.method=o.toUpperCase(),l==="application/json"?(s.headers=new Headers({"Content-Type":l}),s.body=JSON.stringify(r.json)):l==="text/plain"?s.body=r.text:l==="application/x-www-form-urlencoded"&&r.formData?s.body=Mf(r.formData):s.body=r.formData}return new Request(i,s)}function Mf(t){let e=new URLSearchParams;for(let[n,r]of t.entries())e.append(n,typeof r=="string"?r:r.name);return e}function sv(t){let e=new FormData;for(let[n,r]of t.entries())e.append(n,r);return e}function iP(t,e,n,r,i,s){let o={},l=null,u,c=!1,d={},f=r&&un(r[1])?r[1].error:void 0;return n.forEach((m,E)=>{let R=e[E].route.id;if(ye(!Wi(m),"Cannot handle redirect results in processLoaderData"),un(m)){let C=m.error;f!==void 0&&(C=f,f=void 0),l=l||{};{let O=Ws(t,R);l[O.route.id]==null&&(l[O.route.id]=C)}o[R]=void 0,c||(c=!0,u=uh(m.error)?m.error.status:500),m.headers&&(d[R]=m.headers)}else Hi(m)?(i.set(R,m.deferredData),o[R]=m.deferredData.data,m.statusCode!=null&&m.statusCode!==200&&!c&&(u=m.statusCode),m.headers&&(d[R]=m.headers)):(o[R]=m.data,m.statusCode&&m.statusCode!==200&&!c&&(u=m.statusCode),m.headers&&(d[R]=m.headers))}),f!==void 0&&r&&(l={[r[0]]:f},o[r[0]]=void 0),{loaderData:o,errors:l,statusCode:u||200,loaderHeaders:d}}function ov(t,e,n,r,i,s,o,l){let{loaderData:u,errors:c}=iP(e,n,r,i,l);for(let d=0;d<s.length;d++){let{key:f,match:m,controller:E}=s[d];ye(o!==void 0&&o[d]!==void 0,"Did not find corresponding fetcher result");let R=o[d];if(!(E&&E.signal.aborted))if(un(R)){let C=Ws(t.matches,m==null?void 0:m.route.id);c&&c[C.route.id]||(c=Ye({},c,{[C.route.id]:R.error})),t.fetchers.delete(f)}else if(Wi(R))ye(!1,"Unhandled fetcher revalidation redirect");else if(Hi(R))ye(!1,"Unhandled fetcher deferred data");else{let C=Wr(R.data);t.fetchers.set(f,C)}}return{loaderData:u,errors:c}}function av(t,e,n,r){let i=Ye({},e);for(let s of n){let o=s.route.id;if(e.hasOwnProperty(o)?e[o]!==void 0&&(i[o]=e[o]):t[o]!==void 0&&s.route.loader&&(i[o]=t[o]),r&&r.hasOwnProperty(o))break}return i}function lv(t){return t?un(t[1])?{actionData:{}}:{actionData:{[t[0]]:t[1].data}}:{}}function Ws(t,e){return(e?t.slice(0,t.findIndex(r=>r.route.id===e)+1):[...t]).reverse().find(r=>r.route.hasErrorBoundary===!0)||t[0]}function uv(t){let e=t.length===1?t[0]:t.find(n=>n.index||!n.path||n.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:e}],route:e}}function qt(t,e){let{pathname:n,routeId:r,method:i,type:s,message:o}=e===void 0?{}:e,l="Unknown Server Error",u="Unknown @remix-run/router error";return t===400?(l="Bad Request",s==="route-discovery"?u='Unable to match URL "'+n+'" - the `unstable_patchRoutesOnMiss()` '+(`function threw the following error:
 ...
 *
 * @license MIT
 */function Sc(){return Sc=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Sc.apply(this,arguments)}const ch=j.createContext(null),_E=j.createContext(null),Ci=j.createContext(null),pm=j.createContext(null),Lr=j.createContext({outlet:null,matches:[],isDataRoute:!1}),wE=j.createContext(null);function pP(t,e){let{relative:n}=e===void 0?{}:e;Do()||ye(!1);let{basename:r,navigator:i}=j.useContext(Ci),{hash:s,pathname:o,search:l}=TE(t,{relative:n}),u=o;return r!=="/"&&(u=o==="/"?r:Rr([r,o])),i.createHref({pathname:u,search:l,hash:s})}function Do(){return j.useContext(pm)!=null}function Al(){return Do()||ye(!1),j.useContext(pm).location}function EE(t){j.useContext(Ci).static||j.useLayoutEffect(t)}function Pl(){let{isDataRoute:t}=j.useContext(Lr);return t?CP():mP()}function mP(){Do()||ye(!1);let t=j.useContext(ch),{basename:e,future:n,navigator:r}=j.useContext(Ci),{matches:i}=j.useContext(Lr),{pathname:s}=Al(),o=JSON.stringify(ah(i,n.v7_relativeSplatPath)),l=j.useRef(!1);return EE(()=>{l.current=!0}),j.useCallback(function(c,d){if(d===void 0&&(d={}),!l.current)return;if(typeof c=="number"){r.go(c);return}let f=lh(c,JSON.parse(o),s,d.relative==="path");t==null&&e!=="/"&&(f.pathname=f.pathname==="/"?e:Rr([e,f.pathname])),(d.replace?r.replace:r.push)(f,d.state,d)},[e,r,o,s,t])}const gP=j.createContext(null);function yP(t){let e=j.useContext(Lr).outlet;return e&&j.createElement(gP.Provider,{value:t},e)}function TE(t,e){let{relative:n}=e===void 0?{}:e,{future:r}=j.useContext(Ci),{matches:i}=j.useContext(Lr),{pathname:s}=Al(),o=JSON.stringify(ah(i,r.v7_relativeSplatPath));return j.useMemo(()=>lh(t,JSON.parse(o),s,n==="path"),[t,o,s,n])}function vP(t,e,n,r){Do()||ye(!1);let{navigator:i}=j.useContext(Ci),{matches:s}=j.useContext(Lr),o=s[s.length-1],l=o?o.params:{};o&&o.pathname;let u=o?o.pathnameBase:"/";o&&o.route;let c=Al(),d;d=c;let f=d.pathname||"/",m=f;if(u!=="/"){let C=u.replace(/^\//,"").split("/");m="/"+f.replace(/^\//,"").split("/").slice(C.length).join("/")}let E=ji(t,{pathname:m});return IP(E&&E.map(C=>Object.assign({},C,{params:Object.assign({},l,C.params),pathname:Rr([u,i.encodeLocation?i.encodeLocation(C.pathname).pathname:C.pathname]),pathnameBase:C.pathnameBase==="/"?u:Rr([u,i.encodeLocation?i.encodeLocation(C.pathnameBase).pathname:C.pathnameBase])})),s,n,r)}function _P(){let t=PP(),e=uh(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return j.createElement(j.Fragment,null,j.createElement("h2",null,"Unexpected Application Error!"),j.createElement("h3",{style:{fontStyle:"italic"}},e),n?j.createElement("pre",{style:i},n):null,null)}const wP=j.createElement(_P,null);class EP extends j.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?j.createElement(Lr.Provider,{value:this.props.routeContext},j.createElement(wE.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function TP(t){let{routeContext:e,match:n,children:r}=t,i=j.useContext(ch);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),j.createElement(Lr.Provider,{value:e},r)}function IP(t,e,n,r){var i;if(e===void 0&&(e=[]),n===void 0&&(n=null),r===void 0&&(r=null),t==null){var s;if(!n)return null;if(n.errors)t=n.matches;else if((s=r)!=null&&s.v7_partialHydration&&e.length===0&&!n.initialized&&n.matches.length>0)t=n.matches;else return null}let o=t,l=(i=n)==null?void 0:i.errors;if(l!=null){let d=o.findIndex(f=>f.route.id&&(l==null?void 0:l[f.route.id])!==void 0);d>=0||ye(!1),o=o.slice(0,Math.min(o.length,d+1))}let u=!1,c=-1;if(n&&r&&r.v7_partialHydration)for(let d=0;d<o.length;d++){let f=o[d];if((f.route.HydrateFallback||f.route.hydrateFallbackElement)&&(c=d),f.route.id){let{loaderData:m,errors:E}=n,R=f.route.loader&&m[f.route.id]===void 0&&(!E||E[f.route.id]===void 0);if(f.route.lazy||R){u=!0,c>=0?o=o.slice(0,c+1):o=[o[0]];break}}}return o.reduceRight((d,f,m)=>{let E,R=!1,C=null,O=null;n&&(E=l&&f.route.id?l[f.route.id]:void 0,C=f.route.errorElement||wP,u&&(c<0&&m===0?(R=!0,O=null):c===m&&(R=!0,O=f.route.hydrateFallbackElement||null)));let T=e.concat(o.slice(0,m+1)),v=()=>{let S;return E?S=C:R?S=O:f.route.Component?S=j.createElement(f.route.Component,null):f.route.element?S=f.route.element:S=d,j.createElement(TP,{match:f,routeContext:{outlet:d,matches:T,isDataRoute:n!=null},children:S})};return n&&(f.route.ErrorBoundary||f.route.errorElement||m===0)?j.createElement(EP,{location:n.location,revalidation:n.revalidation,component:C,error:E,children:v(),routeContext:{outlet:null,matches:T,isDataRoute:!0}}):v()},null)}var IE=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(IE||{}),Rc=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(Rc||{});function SP(t){let e=j.useContext(ch);return e||ye(!1),e}function RP(t){let e=j.useContext(_E);return e||ye(!1),e}function AP(t){let e=j.useContext(Lr);return e||ye(!1),e}function SE(t){let e=AP(),n=e.matches[e.matches.length-1];return n.route.id||ye(!1),n.route.id}function PP(){var t;let e=j.useContext(wE),n=RP(Rc.UseRouteError),r=SE(Rc.UseRouteError);return e!==void 0?e:(t=n.errors)==null?void 0:t[r]}function CP(){let{router:t}=SP(IE.UseNavigateStable),e=SE(Rc.UseNavigateStable),n=j.useRef(!1);return EE(()=>{n.current=!0}),j.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,Sc({fromRouteId:e},s)))},[t,e])}function kP(t){let{to:e,replace:n,state:r,relative:i}=t;Do()||ye(!1);let{future:s,static:o}=j.useContext(Ci),{matches:l}=j.useContext(Lr),{pathname:u}=Al(),c=Pl(),d=lh(e,ah(l,s.v7_relativeSplatPath),u,i==="path"),f=JSON.stringify(d);return j.useEffect(()=>c(JSON.parse(f),{replace:n,state:r,relative:i}),[c,f,i,n,r]),null}function xP(t){return yP(t.context)}function NP(t){let{basename:e="/",children:n=null,location:r,navigationType:i=at.Pop,navigator:s,static:o=!1,future:l}=t;Do()&&ye(!1);let u=e.replace(/^\/*/,"/"),c=j.useMemo(()=>({basename:u,navigator:s,static:o,future:Sc({v7_relativeSplatPath:!1},l)}),[u,l,s,o]);typeof r=="string"&&(r=Pi(r));let{pathname:d="/",search:f="",hash:m="",state:E=null,key:R="default"}=r,C=j.useMemo(()=>{let O=No(d,u);return O==null?null:{location:{pathname:O,search:f,hash:m,state:E,key:R},navigationType:i}},[u,d,f,m,E,R,i]);return C==null?null:j.createElement(Ci.Provider,{value:c},j.createElement(pm.Provider,{children:n,value:C}))}new Promise(()=>{});function DP(t){let e={hasErrorBoundary:t.ErrorBoundary!=null||t.errorElement!=null};return t.Component&&Object.assign(e,{element:j.createElement(t.Component),Component:void 0}),t.HydrateFallback&&Object.assign(e,{hydrateFallbackElement:j.createElement(t.HydrateFallback),HydrateFallback:void 0}),t.ErrorBoundary&&Object.assign(e,{errorElement:j.createElement(t.ErrorBoundary),ErrorBoundary:void 0}),e}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ua(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Gx(t,e=!1){const n=Et(t),r=await n.getIdToken(e),i=Cm(r);oe(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:Ua(kd(i.auth_time)),issuedAtTime:Ua(kd(i.iat)),expirationTime:Ua(kd(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function kd(t){return Number(t)*1e3}function Cm(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return Hu("JWT malformed, contained fewer than 3 sections"),null;try{const i=nT(n);return i?JSON.parse(i):(Hu("Failed to decode base64 JWT payload"),null)}catch(i){return Hu("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function Wv(t){const e=Cm(t);return oe(e,"internal-error"),oe(typeof e.exp<"u","internal-error"),oe(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gN(t,e){const n=Rm(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(Nc(s,e??{}))return i;zn(i,"already-initialized")}return n.initialize({options:e})}function yN(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Ir);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function vN(t,e,n){const r=ps(t);oe(r._canInitEmulator,r,"emulator-config-failed"),oe(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=xT(e),{host:o,port:l}=_N(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${s}//${o}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),wN()}function xT(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function _N(t){const e=xT(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Xv(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:Xv(o)}}}function Xv(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function wN(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xN(t,e,n=!1){const{auth:r}=t;if(er(r.app))return Promise.reject(Ar(r));const i="reauthenticate";try{const s=await _o(t,DT(r,i,e,t),n);oe(s.idToken,r,"internal-error");const o=Cm(s.idToken);oe(o,r,"internal-error");const{sub:l}=o;return oe(t.uid===l,r,"user-mismatch"),ls._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&zn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hm{constructor(){this.Ir=new Ct(yt.Tr),this.Er=new Ct(yt.dr)}isEmpty(){return this.Ir.isEmpty()}addReference(e,n){const r=new yt(e,n);this.Ir=this.Ir.add(r),this.Er=this.Er.add(r)}Ar(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Rr(new yt(e,n))}Vr(e,n){e.forEach(r=>this.removeReference(r,n))}mr(e){const n=new re(new Be([])),r=new yt(n,e),i=new yt(n,e+1),s=[];return this.Er.forEachInRange([r,i],o=>{this.Rr(o),s.push(o.key)}),s}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Er=this.Er.delete(e)}pr(e){const n=new re(new Be([])),r=new yt(n,e),i=new yt(n,e+1);let s=we();return this.Er.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new yt(e,0),r=this.Ir.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class yt{constructor(e,n){this.key=e,this.yr=n}static Tr(e,n){return re.comparator(e.key,n.key)||Pe(e.yr,n.yr)}static dr(e,n){return Pe(e.yr,n.yr)||re.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,mM=Ve.span`
  ...
  font-weight: 900;
  margin-right: 10px;
`,G_=sI(Ca,"icecream","Mtu2EMz2fp8FKkItKQm5");function gM(){const t=ii.currentUser.uid,e=ii.currentUser.displayName,n=Pl(),[r,i]=j.useState(!1),[s,o]=j.useState(!1),[l,u]=j.useState(!1),[c,d]=j.useState([]),[f,m]=j.useState([]),[E,R]=j.useState([]),[C,O]=j.useState([]),[T,v]=j.useState(""),[S,b]=j.useState(!1),F=async()=>{i(!0);try{const K=Md(Ld(Ca,"icecream"));await Fd(K,ae=>{const We=ae.docs.map(de=>de.data());m(We[0].recipe),v(We[0].lastUser)})}catch(K){console.log(K)}finally{i(!1)}},P=async()=>{i(!0);try{const K=Md(Ld(Ca,"rank"));await Fd(K,()=>{b(!0),setTimeout(()=>{b(!1)},1e3)})}catch(K){console.log(K)}finally{i(!1)}},_=K=>{const ae=[K,...E];R(ae)},g=()=>{o(!0);try{if(f.length!==E.length)return!1;for(let K=0;K<f.length;K++)if(f[K]!==E[K])return!1;N()}catch(K){console.log(K)}finally{R([]),k(),I(),o(!1)}},w=K=>{let ae=K.slice();for(let We=ae.length-1;We>0;We--){const de=Math.floor(Math.random()*(We+1));[ae[We],ae[de]]=[ae[de],ae[We]]}return ae},I=async()=>{i(!0);const K=w([0,1,2]);O(K);try{await Vd(G_,{recipe:K})}catch(ae){console.log(ae)}finally{i(!1)}},k=async()=>{u(!0);try{const K=Md(Ld(Ca,"rank"),KL("score","desc"));await Fd(K,ae=>{const We=ae.docs.map(de=>de.data());d(We)})}catch(K){console.log(K)}finally{u(!1)}},N=async()=>{if(!ii.currentUser)return;const K=sI(Ca,"rank",t),ae=await JL(K);if(await Vd(G_,{lastUser:e}),ae.exists()){const de=(ae.data().score||0)+1;await Vd(K,{score:de})}else await ZL(K,{score:1,userName:e||"Unknown User"})},A=async()=>{try{await ii.signOut(),n("/login")}catch(K){console.error("Error signing out: ",K)}};return j.useEffect(()=>{F(),k(),P()},[]),j.useEffect(()=>{E.length===3&&g()},[E]),H.jsx(H.Fragment,{children:H.jsxs(nM,{children:[H.jsxs(rM,{className:S?"active":"",children:[T," 성공!!"]}),H.jsxs(iM,{children:[H.jsx(mM,{children:e}),H.jsx(sM,{onClick:()=>{A()},children:"로그아웃"})]}),H.jsx(oM,{children:"ICECREAM FACTORY"}),H.jsxs(aM,{children:[H.jsx(lM,{children:r?H.jsx(jd,{children:"Loading..."}):H.jsxs(H.Fragment,{children:[H.jsx("p",{className:"title",children:"만들어주세요!"}),H.jsx("div",{className:"object",children:f.map((K,ae)=>H.jsx("div",{className:`${K===0?"strawberry":K===1?"choco":"mint"} ${ae===0?"one":ae===1?"two":"three"}`},ae))})]})}),H.jsx(uM,{children:s?H.jsx(jd,{children:"Loading.."}):H.jsxs(H.Fragment,{children:[H.jsx("p",{className:"title",children:"나의 조합"}),H.jsx("div",{className:`${E.length===2?"second":E.length===3?"third":""} object`,children:E.map((K,ae)=>H.jsx("div",{className:`${K===0?"strawberry":K===1?"choco":"mint"} ${ae===0?"one":ae===1?"two":"three"}`},ae))})]})})]}),H.jsxs(cM,{children:[H.jsxs("div",{children:[H.jsx(Ud,{className:"strawberry",onClick:()=>_(0)}),H.jsx(Ud,{className:"choco",onClick:()=>_(1)}),H.jsx(Ud,{className:"mint-choco",onClick:()=>_(2)})]}),H.jsx("span",{children:"SELECT ME!!!"})]}),H.jsxs(hM,{children:[H.jsxs("div",{className:"first-user",children:[H.jsx("p",{className:"title",children:"최고의 실력자"}),H.jsx("span",{className:"name",children:c.length>0?c[0].userName:"1등 없음!"})]}),l?H.jsx(jd,{children:"Loading..."}):H.jsxs(dM,{children:[H.jsx("div",{className:"index",children:"기회가 있는 자"}),H.jsx(fM,{children:c.slice(1).map((K,ae)=>H.jsxs(pM,{children:[H.jsx("span",{children:K.userName}),H.jsx("span",{children:K.score})]},ae))})]})]})]})})}function yM(){return H.jsx("div",{children:"hello"})}const wI=Ve.div`
  display: flex;
  align-items: center;
  justify-content: center;
  flex-direction: column;
...
`;function TM(){const[t,e]=j.useState(!0),n=async()=>{await ii.authStateReady(),e(!1)};return j.useEffect(()=>{n()},[]),H.jsxs(H.Fragment,{children:[H.jsx(EM,{}),t?H.jsx(tk,{}):H.jsx(KP,{router:wM})]})}zd.createRoot(document.getElementById("root")).render(H.jsx(Mn.StrictMode,{children:H.jsx(TM,{})}));
